...
//lab10 declarations of variables
//------------------------------------------------------------------------
int paTable[NPROC];		/* pid[i].parent == paTable[i]*/
int sonNumaTable[NPROC];		/* pid[i].numSons == sonNumaTable[i]*/
int waitType[NPROC];		/* wait type : */
struct	mblock *curBlock = &memlist;
/*------------------------------------------------------------------------
*/
