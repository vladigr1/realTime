...
//new we added
//------------------------------------------------------------
int	myqhead;		/* index to head myq entry	in q 	*/
int	myqtail;		/* index to tail myq entry  in q	*/
//long	rctod;			/* time-of-day (tics since startup)	td when call reseve_cpu*/
long rctime[NPROC];
int		rcflag;
/*--------------------------------------------------------------
*/
...
//------------------------------------------------------------
#undef NQENT
#define NQENT NPROC + NSEM + NSEM + 6
/*--------------------------------------------------------------
*/
...
//new we added
//------------------------------------------------------------
	myqtail = 1 + ( myqhead=newqueue() );	/* initialize myq list */
/*--------------------------------------------------------------
*/	
#ifdef	MEMMARK
