...
xmain()
{
    ...
    resume( create(Inc, INITSTK, INITPRIO+50, "proc 2", 1, &count2) );
    resume( create(Inc, INITSTK, INITPRIO+100, "proc 3", 1, &count3) );
    resume( create(Pr, INITSTK, INITPRIO+150, "proc 4", 0) );
}
